...
// line 577 "../../../../src/NuSMVMetamodel.ump"
public class InitConstraint extends ModuleElement
{
  ...
  public InitConstraint(BasicExpression aBasicExpression)
  {
    super();
    terminated = false;
    if (!setBasicExpression(aBasicExpression))
    {
      throw new RuntimeException("Unable to create InitConstraint due to aBasicExpression. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
    // line 580 "../../../../src/NuSMVMetamodel.ump"
    setHeader("INIT"); setTerminated(false);
