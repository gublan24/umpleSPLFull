...
// line 264 "../../../../src/NuSMVMetamodel.ump"
public class IVarDeclaration extends ModuleElement
{
  ...
  public static final String TEXT_0 = NL + "   -- This part declares input variables for the given NuSMV module --" + NL + "  ";
  ...
  public IVarDeclaration(VariableSpecifier... allVariableSpecifiers)
  {
    super();
    ...
    {
      throw new RuntimeException("Unable to create IVarDeclaration, must have at least 1 variableSpecifiers. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
    // line 267 "../../../../src/NuSMVMetamodel.ump"
    setHeader("IVAR");
