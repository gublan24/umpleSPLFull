...
class Y0_1__0_n
  ...
  #Y0_1__0_n Attributes - for documentation purposes
  #attr_reader :v

  #Y0_1__0_n Associations - for documentation purposes
  #attr_reader :xVar
  ...
  def add_xVar(a_xVar)
    ...
    if number_of_xVar >= Y0_1__0_n.maximum_number_of_xVar
      return was_added
    end

    existing_y0_1__0_n = a_xVar.get_y0_1__0_n
    if existing_y0_1__0_n.nil?
      a_xVar.set_y0_1__0_n(self)
    elsif !existing_y0_1__0_n.eql?(self)
      existing_y0_1__0_n.remove_xVar(a_xVar)
      add_xVar(a_xVar)
    else
      @xVar << a_xVar
    end
  ...
  def delete
    @deleted = true
    while @xVar.any? do
      @xVar[0].instance_variable_set("@y0_1__0_n",nil)
