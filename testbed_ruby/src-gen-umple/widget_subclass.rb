...
class WidgetSubclass < WidgetImmutableB
  ...
  def initialize(a_name, a_type, all_widgetImmutableBs)
    ...
    raise "Unable to create WidgetSubclass, must have 2 or fewer @widgetImmutableBs, no duplicates. See http://manual.umple.org?RE001ViolationofImmutability.html" unless did_add_widgetImmutableBs
    @initialized = true
  end
