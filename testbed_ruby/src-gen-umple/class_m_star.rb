...
class ClassMStar
  ...
  def initialize(all_classOtherclasses)
    ...
    raise "Unable to create ClassMStar, must have at least 2 @classOtherclasses. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_classOtherclasses
    @initialized = true
  end
