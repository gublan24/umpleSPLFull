...
class Y0_n__m_n
  ...
  #Y0_n__m_n Attributes - for documentation purposes
  #attr_reader :v

  #Y0_n__m_n Associations - for documentation purposes
  #attr_reader :xVar
  ...
  def is_number_of_xVar_valid
    is_valid = number_of_xVar >= Y0_n__m_n.minimum_number_of_xVar and number_of_xVar <= Y0_n__m_n.maximum_number_of_xVar
    is_valid
  end
  ...
  def add_xVar(a_xVar)
    ...
    if number_of_xVar >= Y0_n__m_n.maximum_number_of_xVar
      return was_added
    end

    @xVar << a_xVar
    if a_xVar.index_of_y0_n__m_n(self) != -1
      was_added = true
    else
      was_added = a_xVar.add_y0_n__m_n(self)
      unless was_added
        @xVar.delete(a_xVar)
      end
    end
  ...
  def remove_xVar(a_xVar)
    ...
    if number_of_xVar <= Y0_n__m_n.minimum_number_of_xVar
      return was_removed
    end
    ...
    if a_xVar.index_of_y0_n__m_n(self) == -1
      ...
      was_removed = a_xVar.remove_y0_n__m_n(self)
