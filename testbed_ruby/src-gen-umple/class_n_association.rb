...
class ClassNAssociation
  ...
  def initialize(all_otherclasses)
    ...
    raise "Unable to create ClassNAssociation, must have 2 @otherclasses. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_otherclasses
    @initialized = true
  end
