...
class YR_m_n__star
  ...
  #YR_m_n__star Attributes - for documentation purposes
  #attr_reader :v

  #YR_m_n__star Associations - for documentation purposes
  #attr_reader :zVar
  ...
  def add_zVar(a_zVar)
    ...
    @zVar << a_zVar
    if a_zVar.index_of_y_m_n__star(self) != -1
      was_added = true
    else
      was_added = a_zVar.add_y_m_n__star(self)
      unless was_added
        @zVar.delete(a_zVar)
      end
    end
  ...
  def remove_zVar(a_zVar)
    ...
    if a_zVar.index_of_y_m_n__star(self) == -1
      ...
      was_removed = a_zVar.remove_y_m_n__star(self)
