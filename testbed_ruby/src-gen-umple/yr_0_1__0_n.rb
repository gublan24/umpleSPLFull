...
class YR_0_1__0_n
  ...
  #YR_0_1__0_n Attributes - for documentation purposes
  #attr_reader :v

  #YR_0_1__0_n Associations - for documentation purposes
  #attr_reader :zVar
  ...
  def add_zVar(a_zVar)
    ...
    if number_of_zVar >= YR_0_1__0_n.maximum_number_of_zVar
      return was_added
    end

    existing_y_0_1__0_n = a_zVar.get_y_0_1__0_n
    if existing_y_0_1__0_n.nil?
      a_zVar.set_y_0_1__0_n(self)
    elsif !existing_y_0_1__0_n.eql?(self)
      existing_y_0_1__0_n.remove_zVar(a_zVar)
      add_zVar(a_zVar)
    else
      @zVar << a_zVar
    end
