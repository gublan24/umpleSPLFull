...
class ClassN
  ...
  def initialize(all_classOtherclasses)
    ...
    raise "Unable to create ClassN, must have 2 @classOtherclasses. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_classOtherclasses
    @initialized = true
  end
