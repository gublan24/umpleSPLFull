...
class MultipleSortedCourse
  ...
  def initialize(a_code, a_multipleSortedAcademy)
    ...
    raise "Unable to create multipleSortedCourse due to @multipleSortedAcademy. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_multipleSortedAcademy
