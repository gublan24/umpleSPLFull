...
class ClassMToN
  ...
  def initialize(all_classOtherclasses)
    ...
    raise "Unable to create ClassMToN, must have 2 to 3 @classOtherclasses. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_classOtherclasses
    @initialized = true
  end
