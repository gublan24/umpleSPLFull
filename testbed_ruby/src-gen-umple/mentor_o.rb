...
class MentorO
  ...
  def initialize(a_name, all_students)
    ...
    raise "Unable to create MentorO, must have 2 to 4 @students. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_students
    @program = nil
    @initialized = true
  end
