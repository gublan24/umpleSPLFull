...
class YM_star
  ...
  #YM_star Attributes - for documentation purposes
  #attr_reader :v

  #YM_star Associations - for documentation purposes
  #attr_reader :xVar
  ...
  def add_xVar(a_xVar)
    ...
    @xVar << a_xVar
    if a_xVar.index_of_ym_star(self) != -1
      was_added = true
    else
      was_added = a_xVar.add_ym_star(self)
      unless was_added
        @xVar.delete(a_xVar)
      end
    end
  ...
  def remove_xVar(a_xVar)
    ...
    if a_xVar.index_of_ym_star(self) == -1
      ...
      was_removed = a_xVar.remove_ym_star(self)
  ...
  def delete
    ...
    copy_of_xVar.each do |a_xVar|
      if a_xVar.number_of_ym_star <= XM_star.minimum_number_of_ym_star
        a_xVar.delete
      else
        a_xVar.remove_ym_star(self)
      end
    end
  end
