...
class YR_0_n__m
  ...
  #YR_0_n__m Attributes - for documentation purposes
  #attr_reader :v

  #YR_0_n__m Associations - for documentation purposes
  #attr_reader :zVar
  ...
  def is_number_of_zVar_valid
    is_valid = number_of_zVar >= YR_0_n__m.minimum_number_of_zVar and number_of_zVar <= YR_0_n__m.maximum_number_of_zVar
    is_valid
  end
  ...
  def add_zVar(a_zVar)
    ...
    if number_of_zVar >= YR_0_n__m.maximum_number_of_zVar
      return was_added
    end

    @zVar << a_zVar
    if a_zVar.index_of_y_0_n__m(self) != -1
      was_added = true
    else
      was_added = a_zVar.add_y_0_n__m(self)
      unless was_added
        @zVar.delete(a_zVar)
      end
    end
  ...
  def remove_zVar(a_zVar)
    ...
    if number_of_zVar <= YR_0_n__m.minimum_number_of_zVar
      return was_removed
    end
    ...
    if a_zVar.index_of_y_0_n__m(self) == -1
      ...
      was_removed = a_zVar.remove_y_0_n__m(self)
