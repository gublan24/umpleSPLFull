...
class Y0_n__star
  ...
  #Y0_n__star Attributes - for documentation purposes
  #attr_reader :v

  #Y0_n__star Associations - for documentation purposes
  #attr_reader :xVar
  ...
  def add_xVar(a_xVar)
    ...
    @xVar << a_xVar
    if a_xVar.index_of_y0_n__star(self) != -1
      was_added = true
    else
      was_added = a_xVar.add_y0_n__star(self)
      unless was_added
        @xVar.delete(a_xVar)
      end
    end
  ...
  def remove_xVar(a_xVar)
    ...
    if a_xVar.index_of_y0_n__star(self) == -1
      ...
      was_removed = a_xVar.remove_y0_n__star(self)
