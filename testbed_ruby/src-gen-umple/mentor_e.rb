...
class MentorE
  ...
  def initialize(all_students)
    ...
    raise "Unable to create MentorE, must have 2 to 5 @students. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_students
    @program = nil
    @initialized = true
  end
