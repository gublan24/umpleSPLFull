...
class YR_0_n__0_n
  ...
  #YR_0_n__0_n Attributes - for documentation purposes
  #attr_reader :v

  #YR_0_n__0_n Associations - for documentation purposes
  #attr_reader :zVar
  ...
  def add_zVar(a_zVar)
    ...
    if number_of_zVar >= YR_0_n__0_n.maximum_number_of_zVar
      return was_added
    end

    @zVar << a_zVar
    if a_zVar.index_of_y_0_n__0_n(self) != -1
      was_added = true
    else
      was_added = a_zVar.add_y_0_n__0_n(self)
      unless was_added
        @zVar.delete(a_zVar)
      end
    end
  ...
  def remove_zVar(a_zVar)
    ...
    if a_zVar.index_of_y_0_n__0_n(self) == -1
      ...
      was_removed = a_zVar.remove_y_0_n__0_n(self)
