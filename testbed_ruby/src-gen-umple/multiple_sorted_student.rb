...
class MultipleSortedStudent
  ...
  def initialize(a_id, a_name, a_multipleSortedAcademy)
    ...
    raise "Unable to create registrant due to @multipleSortedAcademy. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_multipleSortedAcademy
