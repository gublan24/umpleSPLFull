...
class MentorF
  ...
  def initialize(all_students)
    ...
    raise "Unable to create MentorF, must have at least 2 @students. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_students
    @program = nil
    @initialized = true
  end
