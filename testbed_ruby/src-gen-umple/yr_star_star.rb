...
class YR_star_star
  ...
  #YR_star_star Attributes - for documentation purposes
  #attr_reader :v

  #YR_star_star Associations - for documentation purposes
  #attr_reader :zVar
  ...
  def add_zVar(a_zVar)
    ...
    @zVar << a_zVar
    if a_zVar.index_of_y_star_star(self) != -1
      was_added = true
    else
      was_added = a_zVar.add_y_star_star(self)
      unless was_added
        @zVar.delete(a_zVar)
      end
    end
  ...
  def remove_zVar(a_zVar)
    ...
    if a_zVar.index_of_y_star_star(self) == -1
      ...
      was_removed = a_zVar.remove_y_star_star(self)
