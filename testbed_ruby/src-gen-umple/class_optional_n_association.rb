...
class ClassOptionalNAssociation
  ...
  def initialize(all_otherclasses)
    ...
    raise "Unable to create ClassOptionalNAssociation, must have 2 or fewer @otherclasses, no duplicates. See http://manual.umple.org?RE001ViolationofImmutability.html" unless did_add_otherclasses
    @initialized = true
  end
