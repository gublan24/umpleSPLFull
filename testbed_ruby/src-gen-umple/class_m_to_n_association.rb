...
class ClassMToNAssociation
  ...
  def initialize(all_otherclasses)
    ...
    raise "Unable to create ClassMToNAssociation, must have 2 to 3 @otherclasses. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_otherclasses
    @initialized = true
  end
