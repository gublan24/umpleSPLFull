...
class ClassOptionalN
  ...
  def initialize(all_classOtherclasses)
    ...
    raise "Unable to create ClassOptionalN, must have 2 or fewer @classOtherclasses, no duplicates. See http://manual.umple.org?RE001ViolationofImmutability.html" unless did_add_classOtherclasses
    @initialized = true
  end
