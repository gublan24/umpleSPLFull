...
class MultipleSortedRegistration
  ...
  def initialize(a_multipleSortedCourse, a_multipleSortedStudent)
    ...
    raise "Unable to create multipleSortedRegistration due to @multipleSortedCourse. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_multipleSortedCourse
    @multipleSortedStudent = nil
    did_add_multipleSortedStudent = set_multipleSortedStudent(a_multipleSortedStudent)
    raise "Unable to create multipleSortedRegistration due to @multipleSortedStudent. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_multipleSortedStudent
    @initialized = true
  end
