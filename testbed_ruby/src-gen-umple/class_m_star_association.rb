...
class ClassMStarAssociation
  ...
  def initialize(all_otherclasses)
    ...
    raise "Unable to create ClassMStarAssociation, must have at least 2 @otherclasses. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_otherclasses
    @initialized = true
  end
