...
class MentorAL
  ...
  def initialize(a_name, all_students)
    ...
    raise "Unable to create MentorAL, must have at least 3 @students. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html" unless did_add_students
    @program = nil
    @initialized = true
  end
