...
class ClassMStarAssociation
{
  ...
  public function __construct($allOtherclasses)
  {
    ...
    {
      throw new Exception("Unable to create ClassMStarAssociation, must have at least 2 otherclasses. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
