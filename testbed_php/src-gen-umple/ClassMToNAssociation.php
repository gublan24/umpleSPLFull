...
class ClassMToNAssociation
{
  ...
  public function __construct($allOtherclasses)
  {
    ...
    {
      throw new Exception("Unable to create ClassMToNAssociation, must have 2 to 3 otherclasses. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
