...
class ClassNAssociation
{
  ...
  public function __construct($allOtherclasses)
  {
    ...
    {
      throw new Exception("Unable to create ClassNAssociation, must have 2 otherclasses. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
