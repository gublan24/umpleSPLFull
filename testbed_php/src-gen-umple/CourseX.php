...
class CourseX
{
  ...
  public function darken()
  {
    ...
    $aStatusOpen = $this->statusOpen;
    if ($aStatusOpen == self::$StatusOpenGreen)
    {
      $this->exitStatusOpen();
      $this->setStatusOpen(self::$StatusOpenBlack);
      $wasEventProcessed = true;
    }
    return $wasEventProcessed;
  }
  ...
  public function check()
  {
    ...
    {
      $this->exitStatusOpenGreenGreenStatus();
  ...
  private function exitStatusOpen()
  {
    ...
    elseif ($this->statusOpen == self::$StatusOpenBlack)
    {
      $this->setStatusOpen(self::$StatusOpenNull);
    }
  }
  ...
  private function exitStatusOpenGreenGreenStatus()
  {
