...
class ClassMStar
{
  ...
  public function __construct($allClassOtherclasses)
  {
    ...
    {
      throw new Exception("Unable to create ClassMStar, must have at least 2 classOtherclasses. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
