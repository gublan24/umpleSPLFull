...
class ClassOptionalNAssociation
{
  ...
  public function __construct($allOtherclasses)
  {
    ...
    {
      throw new Exception("Unable to create ClassOptionalNAssociation, must have 2 or fewer otherclasses, no duplicates. See http://manual.umple.org?RE001ViolationofImmutability.html");
    }
  }
  ...
  public function getOtherclass_index($index)
  {
