...
class ClassManyAssociation
{
  ...
  public function __construct($allOtherclasses)
  {
    ...
    {
      throw new Exception("Unable to create ClassManyAssociation, must not have duplicate otherclasses. See http://manual.umple.org?RE001ViolationofImmutability.html");
    }
  }
