...
class ClassOptionalN
{
  ...
  public function __construct($allClassOtherclasses)
  {
    ...
    {
      throw new Exception("Unable to create ClassOptionalN, must have 2 or fewer classOtherclasses, no duplicates. See http://manual.umple.org?RE001ViolationofImmutability.html");
    }
  }
