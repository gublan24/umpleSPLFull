...
class YR_m_n__1
{
  ...
  public function __construct($aZVar)
  {
    ...
    if (!$didAddZVar)
    {
      throw new Exception("Unable to create y_m_n__1 due to zVar. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
  ...
  public function setZVar($aZVar)
  {
    ...
    {
      $didRemove = $existingZVar->removeY_m_n__1($this);
      if (!$didRemove)
      {
