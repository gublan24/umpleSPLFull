...
// line 334 "../../../../../src/TestHarnessPooledStateMachine.ump"
public class PooledSM_timedTransition_1 implements Runnable
{
  ...
  //PooledSM_timedTransition_1 Attributes
  private String log;

  //PooledSM_timedTransition_1 State Machines
  ...
  //enumeration type of messages accepted by PooledSM_timedTransition_1
  protected enum MessageType { ev0_M, timeouts1Tos2_M, ev2_M, ev3_M, null_M }

  // Map for a PooledSM_timedTransition_1 pooled state machine that allows querying which events are possible in each map
  ...
  public PooledSM_timedTransition_1()
  {
    log = "initial value";
    setSm(Sm.s0);
    pool = new MessagePool();
    removal=new Thread(this);
    //start the thread of PooledSM_timedTransition_1
    removal.start();
  }
  ...
  private void setSm(Sm aSm)
  {
    ...
    {
      case s0:
        // line 338 "../../../../../src/TestHarnessPooledStateMachine.ump"
        log = "running";
        break;
      case s1:
  ...
  {
    private PooledSM_timedTransition_1 controller;
    private String timeoutMethodName;
    private double howLongInSeconds;
    private Timer timer;
    
    public TimedEventHandler(PooledSM_timedTransition_1 aController, String aTimeoutMethodName, double aHowLongInSeconds)
    {
