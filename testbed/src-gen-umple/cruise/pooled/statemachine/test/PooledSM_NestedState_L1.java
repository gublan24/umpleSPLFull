...
// line 88 "../../../../../src/TestHarnessPooledStateMachine.ump"
public class PooledSM_NestedState_L1 implements Runnable
{
  ...
  //PooledSM_NestedState_L1 State Machines
  ...
  //enumeration type of messages accepted by PooledSM_NestedState_L1
  protected enum MessageType { e1_M, e2_M, e3_M, e4_M, e5_M, null_M }

  // Map for a PooledSM_NestedState_L1 pooled state machine that allows querying which events are possible in each map
  ...
  public PooledSM_NestedState_L1()
  {
    setSmS2(SmS2.Null);
    setSm(Sm.s1);
    pool = new MessagePool();
    removal=new Thread(this);
    //start the thread of PooledSM_NestedState_L1
    removal.start();
  }
