...
// line 715 "../../../src/TestHarnessAssociations.ump"
public class SortedSerializableAcademy implements java.io.Serializable
{
  ...
  public SortedSerializableAcademy()
  {
    sortedSerializableCoursesPriority = 
      Comparator.comparing(SortedSerializableCourse::getCode);
    registrantsPriority = 
      Comparator.comparing(SortedSerializableStudent::getId);
  ...
  public SortedSerializableCourse addSortedSerializableCourse(String aCode)
  {
  ...
  public boolean addSortedSerializableCourse(SortedSerializableCourse aSortedSerializableCourse)
  {
    ...
    wasAdded = true;
    if(wasAdded)
        Collections.sort(sortedSerializableCourses, sortedSerializableCoursesPriority);
