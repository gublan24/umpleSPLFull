...
// line 725 "../../../src/TestHarnessAssociations.ump"
public class SortedSerializableCourse implements java.io.Serializable
{
  ...
  public SortedSerializableCourse(String aCode, SortedSerializableAcademy aSortedSerializableAcademy)
  {
    code = aCode;
    sortedSerializableRegistrationsPriority = 
      Comparator.comparing(SortedSerializableRegistration::getName);
  ...
  public boolean addSortedSerializableRegistration(SortedSerializableRegistration aSortedSerializableRegistration)
  {
    ...
    wasAdded = true;
    if(wasAdded)
        Collections.sort(sortedSerializableRegistrations, sortedSerializableRegistrationsPriority);
