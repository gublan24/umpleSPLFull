...
// line 252 "../../../../src/TestHarnessTracerStateMachine.ump"
public class NestedStateLevel1
{
  ...
  //NestedStateLevel1 State Machines
  ...
  public boolean e1()
  {
    ...
    switch (aStm)
    {
      case sLevel1:
        exitStmSLevel1();
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",TestHarnessTracerStateMachine.ump,284,NestedStateLevel1,"+System.identityHashCode(this)+",sm_t,sLevel1,e1,sLevel2b" );
