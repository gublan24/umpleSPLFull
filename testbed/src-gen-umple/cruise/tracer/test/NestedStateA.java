...
// line 190 "../../../../src/TestHarnessTracerStateMachine.ump"
public class NestedStateA
{
  ...
  public boolean e1()
  {
    ...
    switch (aStm)
    {
      case sLevel1:
        exitStmSLevel1();
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",TestHarnessTracerStateMachine.ump,222,NestedStateA,"+System.identityHashCode(this)+",sm_t,sLevel1,e1,sLevel2b" );
  ...
  public boolean e2()
  {
    ...
    switch (aStmSLevel1)
    {
      case sLevel2b:
        exitStmSLevel1();
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",TestHarnessTracerStateMachine.ump,222,NestedStateA,"+System.identityHashCode(this)+",sm_t,sLevel2b,e2,sLevel2aLevel3a" );
  ...
  public boolean e3()
  {
    ...
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",TestHarnessTracerStateMachine.ump,222,NestedStateA,"+System.identityHashCode(this)+",sm_t,sLevel2aLevel3a,e3,sLevel2aLevel3b" );
        setStmSLevel1SLevel2a(StmSLevel1SLevel2a.sLevel2aLevel3b);
        wasEventProcessed = true;
        break;
      case sLevel2aLevel3b:
        exitStmSLevel1SLevel2a();
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",TestHarnessTracerStateMachine.ump,222,NestedStateA,"+System.identityHashCode(this)+",sm_t,sLevel2aLevel3b,e3,sLevel2aLevel3a" );
        setStmSLevel1SLevel2a(StmSLevel1SLevel2a.sLevel2aLevel3a);
        wasEventProcessed = true;
        break;
      default:
  ...
  public boolean e4()
  {
    ...
    switch (aStmSLevel1SLevel2aSLevel2aLevel3b)
    {
      case sLevel2aLevel3bLevel4:
        exitStm();
    ConsoleTracer.handle( System.currentTimeMillis()+","+Thread.currentThread().getId()+",TestHarnessTracerStateMachine.ump,222,NestedStateA,"+System.identityHashCode(this)+",sm_t,sLevel2aLevel3bLevel4,e4,outsideNested" );
