...
// line 11 "../../../src/runtime/IsATrait.ump"
public class IsATrait
{
  ...
  // line 16 "../../../src/runtime/IsATrait.ump"
   public static  void main(String [] argv){
    Thread.currentThread().setUncaughtExceptionHandler(new UmpleExceptionHandler());
    Thread.setDefaultUncaughtExceptionHandler(new UmpleExceptionHandler());
    IsATrait x = new IsATrait();
        x.Foo();
  }
   ...
   * The following method comes from trait Trait.
   * Trait Trait has been used in classes: 'IsATrait' 
   */
  // line 6 "../../../src/runtime/IsATrait.ump"
   public void Foo(){
  ...
  //The following methods Map Java lines back to their original Umple file / line    
    public UmpleSourceData IsATrait_Foo(){ return new UmpleSourceData().setFileNames("IsATrait.ump").setUmpleLines(5).setJavaLines(42).setLengths(2);}
    public UmpleSourceData IsATrait_main(){ return new UmpleSourceData().setFileNames("IsATrait.ump").setUmpleLines(15).setJavaLines(28).setLengths(2);}
