...
// line 6 "../../../src/runtime/ExtendsClassExternal.ump"
public class ExtendsClassExternal extends AbstractClass
{
  ...
  // line 10 "../../../src/runtime/ExtendsClassExternal.ump"
   public void foo(){
    // Do Nothing
  }

  // line 14 "../../../src/runtime/ExtendsClassExternal.ump"
  ...
  //The following methods Map Java lines back to their original Umple file / line    
    public UmpleSourceData ExtendsClassExternal_foo(){ return new UmpleSourceData().setFileNames("ExtendsClassExternal.ump").setUmpleLines(9).setJavaLines(30).setLengths(1);}
    public UmpleSourceData ExtendsClassExternal_main(){ return new UmpleSourceData().setFileNames("ExtendsClassExternal.ump").setUmpleLines(13).setJavaLines(35).setLengths(3);}
