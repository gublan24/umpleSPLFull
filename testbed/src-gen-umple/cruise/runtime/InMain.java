...
public class InMain
{
  ...
  //The following methods Map Java lines back to their original Umple file / line    
    public UmpleSourceData InMain_main(){ return new UmpleSourceData().setFileNames("InMain.ump").setUmpleLines(6).setJavaLines(28).setLengths(4);}
