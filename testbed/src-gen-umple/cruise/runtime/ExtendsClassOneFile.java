...
// line 14 "../../../src/runtime/ExtendsClassOneFile.ump"
public class ExtendsClassOneFile extends AbstractClassOneFile
{
  ...
  // line 18 "../../../src/runtime/ExtendsClassOneFile.ump"
   public void foo(){
    // Do Nothing
  }

  // line 22 "../../../src/runtime/ExtendsClassOneFile.ump"
  ...
  //The following methods Map Java lines back to their original Umple file / line    
    public UmpleSourceData AbstractClassOneFile_DivideByZero(){ return new UmpleSourceData().setFileNames("ExtendsClassOneFile.ump").setUmpleLines(9).setJavaLines(30).setLengths(1);}
    public UmpleSourceData ExtendsClassOneFile_foo(){ return new UmpleSourceData().setFileNames("ExtendsClassOneFile.ump").setUmpleLines(17).setJavaLines(32).setLengths(1);}
    public UmpleSourceData ExtendsClassOneFile_main(){ return new UmpleSourceData().setFileNames("ExtendsClassOneFile.ump").setUmpleLines(21).setJavaLines(37).setLengths(3);}
