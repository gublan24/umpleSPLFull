...
// line 4 "../../../src/runtime/FunctionWithException.ump"
public class FunctionWithException
{
  ...
  // line 7 "../../../src/runtime/FunctionWithException.ump"
  ...
  // line 16 "../../../src/runtime/FunctionWithException.ump"
  ...
  //The following methods Map Java lines back to their original Umple file / line    
    public UmpleSourceData FunctionWithException_throwsException(){ return new UmpleSourceData().setFileNames("FunctionWithException.ump").setUmpleLines(15).setJavaLines(40).setLengths(2);}
    public UmpleSourceData FunctionWithException_main(){ return new UmpleSourceData().setFileNames("FunctionWithException.ump").setUmpleLines(6).setJavaLines(28).setLengths(6);}
