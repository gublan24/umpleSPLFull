...
// line 4 "../../../src/runtime/InAfterCustom.ump"
public class InAfterCustom
{
  ...
  // line 11 "../../../src/runtime/InAfterCustom.ump"
  ...
  // line 16 "../../../src/runtime/InAfterCustom.ump"
   public void foo(){
    int a = 0;
        a++;
    // line 7 "../../../src/runtime/InAfterCustom.ump"
    int b = 0 / 0;
  ...
  //The following methods Map Java lines back to their original Umple file / line    
    public UmpleSourceData InAfterCustom_foo(){ return new UmpleSourceData().setFileNames("InAfterCustom.ump","InAfterCustom.ump").setUmpleLines(7, 15).setJavaLines(40, 36).setLengths(1, 2);}
    public UmpleSourceData InAfterCustom_main(){ return new UmpleSourceData().setFileNames("InAfterCustom.ump").setUmpleLines(10).setJavaLines(28).setLengths(2);}
