...
// line 4 "../../../src/runtime/BeforeAfter.ump"
public class BeforeAfter
{
  ...
  public BeforeAfter(String aFoo)
  {
    foo = aFoo;
  }
  ...
  public boolean setFoo(String aFoo)
  {
    boolean wasSet = false;
    // line 9 "../../../src/runtime/BeforeAfter.ump"
    // This is a before statement
    // END OF UMPLE BEFORE INJECTION
    foo = aFoo;
    wasSet = true;
    // line 13 "../../../src/runtime/BeforeAfter.ump"
  ...
  // line 18 "../../../src/runtime/BeforeAfter.ump"
   public static  void main(String [] argv){
    Thread.currentThread().setUncaughtExceptionHandler(new UmpleExceptionHandler());
    Thread.setDefaultUncaughtExceptionHandler(new UmpleExceptionHandler());
    BeforeAfter x = new BeforeAfter("");
       x.setFoo("");
  }
  ...
  //The following methods Map Java lines back to their original Umple file / line    
    public UmpleSourceData BeforeAfter_setFoo(){ return new UmpleSourceData().setFileNames("BeforeAfter.ump","BeforeAfter.ump").setUmpleLines(9, 13).setJavaLines(33, 38).setLengths(1, 2);}
    public UmpleSourceData BeforeAfter_main(){ return new UmpleSourceData().setFileNames("BeforeAfter.ump").setUmpleLines(17).setJavaLines(53).setLengths(2);}
