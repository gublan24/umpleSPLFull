...
public class Before
{
  ...
  // line 13 "../../../src/runtime/Before.ump"
  ...
  //The following methods Map Java lines back to their original Umple file / line    
    public UmpleSourceData Before_setFoo(){ return new UmpleSourceData().setFileNames("Before.ump").setUmpleLines(9).setJavaLines(33).setLengths(1);}
    public UmpleSourceData Before_main(){ return new UmpleSourceData().setFileNames("Before.ump").setUmpleLines(12).setJavaLines(49).setLengths(2);}
