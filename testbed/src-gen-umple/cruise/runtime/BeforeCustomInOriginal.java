...
// line 4 "../../../src/runtime/BeforeCustomInOriginal.ump"
public class BeforeCustomInOriginal
{
  ...
  // line 11 "../../../src/runtime/BeforeCustomInOriginal.ump"
  ...
  // line 16 "../../../src/runtime/BeforeCustomInOriginal.ump"
   public void foo(){
    // line 7 "../../../src/runtime/BeforeCustomInOriginal.ump"
    int a = 1;
  ...
  //The following methods Map Java lines back to their original Umple file / line    
    public UmpleSourceData BeforeCustomInOriginal_foo(){ return new UmpleSourceData().setFileNames("BeforeCustomInOriginal.ump","BeforeCustomInOriginal.ump").setUmpleLines(7, 15).setJavaLines(38, 36).setLengths(1, 2);}
    public UmpleSourceData BeforeCustomInOriginal_main(){ return new UmpleSourceData().setFileNames("BeforeCustomInOriginal.ump").setUmpleLines(10).setJavaLines(28).setLengths(2);}
