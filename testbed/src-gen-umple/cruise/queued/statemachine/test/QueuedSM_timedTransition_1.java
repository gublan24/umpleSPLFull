...
// line 307 "../../../../../src/TestHarnessQueuedStateMachine.ump"
public class QueuedSM_timedTransition_1 implements Runnable
{
  ...
  //QueuedSM_timedTransition_1 Attributes
  private String log;

  //QueuedSM_timedTransition_1 State Machines
  public enum Sm { s0, s1, s2, s3, s4 }
  private Sm sm;
  
  //enumeration type of messages accepted by QueuedSM_timedTransition_1
  ...
  public QueuedSM_timedTransition_1()
  {
    log = "initial value";
    setSm(Sm.s0);
    queue = new MessageQueue();
    removal=new Thread(this);
    //start the thread of QueuedSM_timedTransition_1
    removal.start();
  }
  ...
  private void setSm(Sm aSm)
  {
    ...
    {
      case s0:
        // line 311 "../../../../../src/TestHarnessQueuedStateMachine.ump"
        log = "running";
        break;
      case s1:
  ...
  {
    private QueuedSM_timedTransition_1 controller;
    private String timeoutMethodName;
    private double howLongInSeconds;
    private Timer timer;
    
    public TimedEventHandler(QueuedSM_timedTransition_1 aController, String aTimeoutMethodName, double aHowLongInSeconds)
    {
