...
// line 134 "../../../../../src/TestHarnessQueuedStateMachine.ump"
public class QueuedSM_NestedStates_level2 implements Runnable
{
  ...
  //QueuedSM_NestedStates_level2 State Machines
  ...
  //enumeration type of messages accepted by QueuedSM_NestedStates_level2
  protected enum MessageType { e_M, f_M, g_M, h_M, i_M, k_M, j_M, m_M }
  ...
  public QueuedSM_NestedStates_level2()
  {
    setSm1S1(Sm1S1.Null);
    setSm1S2(Sm1S2.Null);
    ...
    //start the thread of QueuedSM_NestedStates_level2
    removal.start();
  }
  ...
  public void f ()
  {
    queue.put(new Message(MessageType.f_M, null));
  }

  public void g ()
  {
    queue.put(new Message(MessageType.g_M, null));
  }

  public void h ()
  {
    queue.put(new Message(MessageType.h_M, null));
  }

  public void i ()
  {
    queue.put(new Message(MessageType.i_M, null));
  }

  public void k ()
  {
    queue.put(new Message(MessageType.k_M, null));
  }

  public void j ()
  {
    queue.put(new Message(MessageType.j_M, null));
  }

  public void m ()
  {
    queue.put(new Message(MessageType.m_M, null));
  }
