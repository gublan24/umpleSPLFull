...
// line 5 "../../../../ump/TestGeneratorConsoleMain.ump"
public class TestGeneratorConsoleMain
{
  ...
  public TestGeneratorConsoleMain()
  {}
  ...
  // line 15 "../../../../ump/TestGeneratorConsoleMain.ump"
   public static  void main(String [] args){
    Thread.currentThread().setUncaughtExceptionHandler(new cruise.umple.testgenerator.TestCaseJUnitGenerator.UmpleExceptionHandler());
    Thread.setDefaultUncaughtExceptionHandler(new cruise.umple.testgenerator.TestCaseJUnitGenerator.UmpleExceptionHandler());
    Util util = new Util();
