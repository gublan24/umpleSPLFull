...
// line 51 "../../../../ump/TestCaseTemplate_model.ump"
public class TestCase
{
  ...
  private String concreteLanguage;
  ...
  public boolean setConcreteLanguage(String aConcreteLanguage)
  {
    boolean wasSet = false;
    concreteLanguage = aConcreteLanguage;
    wasSet = true;
    return wasSet;
  }

  public boolean setIsTargeted(boolean aIsTargeted)
  {
    boolean wasSet = false;
  ...
  public String getConcreteLanguage()
  {
    return concreteLanguage;
  }
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "concreteLanguage" + ":" + getConcreteLanguage()+ "," +
            "isTargeted" + ":" + getIsTargeted()+ "," +
            "isConcrete" + ":" + getIsConcrete()+ "]" + System.getProperties().getProperty("line.separator") +
