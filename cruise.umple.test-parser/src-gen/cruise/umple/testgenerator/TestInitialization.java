 ...
 * 
 */
// line 81 "../../../../ump/TestCaseTemplate_model.ump"
public class TestInitialization
{
  ...
  public boolean setTestModel(TestModel aTestModel)
  {
    ...
    {
      existingTestModel.removeTestInitialization(this);
    }
    if (aTestModel != null)
    {
      aTestModel.addTestInitialization(this);
    }
    wasSet = true;
    return wasSet;
  }
  ...
  public void delete()
  {
    ...
    if (testModel != null)
    {
      ...
      this.testModel = null;
      placeholderTestModel.removeTestInitialization(this);
    }
    if (testcase != null)
    {
