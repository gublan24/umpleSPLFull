...
// line 37 "../../../../ump/TestCaseTemplate_model.ump"
public class TestSuite
{
  ...
  public TestSuite(TestModel aTestModel)
  {
    ...
    if (!didAddTestModel)
    {
      throw new RuntimeException("Unable to create testSuite due to testModel. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
